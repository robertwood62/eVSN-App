...
namespace eLiDAR.ViewModels {
    public class EcositeDetailsViewModel: BaseEcositeViewModel {
        ...
        public List<PickerItemsString> ListSoilSampleTechnique { get; set; }
        ...
        public EcositeDetailsViewModel(INavigation navigation, string selectedID) {
            ...
            ListSoilSampleTechnique = PickerService.SoilSampleTechniqueItems().ToList();
        ...
        private PickerItemsString _selectedSoilSampleTechnique = new PickerItemsString { ID = "", NAME = "" };
        public PickerItemsString SelectedSoilSampleTechnique
        {
            get
            {
                _selectedSoilSampleTechnique = PickerService.GetItem(ListSoilSampleTechnique, _ecosite.SOILSAMPLETECHNIQUE);
                return _selectedSoilSampleTechnique;
            }
            set
            {
                SetProperty(ref _selectedSoilSampleTechnique, value);
                _ecosite.SOILSAMPLETECHNIQUE = _selectedSoilSampleTechnique.ID ;
            }
        }
