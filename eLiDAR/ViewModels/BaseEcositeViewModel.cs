...
namespace eLiDAR.ViewModels
{
    public class BaseEcositeViewModel : INotifyPropertyChanged {
        ...
        public string SOILSAMPLETECHNIQUE
        {
            get => _ecosite.SOILSAMPLETECHNIQUE;
            set
            {
                if (!_ecosite.SOILSAMPLETECHNIQUE.Equals(value)) { IsChanged = true; }
                _ecosite.SOILSAMPLETECHNIQUE = value;
                NotifyPropertyChanged("SOILSAMPLETECHNIQUE");
            }
        }
