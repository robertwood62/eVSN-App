...
using eLiDAR.ControlGallery.ControlTemplates;
using System;
...
using eLiDAR.ControlGallery.ProppyControls;
...
namespace eLiDAR.ControlGallery
{
    ...
    public partial class ControlPage : ContentPage
    {
        ...
        private new View ControlTemplate;
        ...
        protected override void OnAppearing()
        {
            ...
            {
                ControlTemplate = (View)Activator.CreateInstance(Type.GetType($"eLiDAR.ControlGallery.ControlTemplates.{_vm.ControlTemplate}"));
            }
            else
            {
