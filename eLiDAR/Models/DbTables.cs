   ...
   //     public double DISTANCE { get; set; }
    ...
    public class TREELIST : TREE
    {
        ...
        public bool IsPlotTypeC
        {
            get
            {
                if (VSNPLOTTYPECODE != null && VSNPLOTTYPECODE.Contains("C"))
                {
                    return true;
                }
                return false;
        ...
        public string SpeciesName
        {
            get
            {
                try
                {
                    ...
                    { 
                        return Services.PickerService.GetValue(Services.PickerService.SpeciesMaster().ToList(), SPECIESCODE); 
                    }
                }
                catch (Exception ex)
                {
    ...
    public class ECOSITE
    {
        ...
        public string SOILSAMPLETECHNIQUE { get; set; }
        public int ERRORCOUNT { get; set; }
        public string ERRORMSG { get; set; }
    }
    [Table("SOIL")]
